...
![Improved gear meshing]({{ site.url }}/assets/200217_gears.jpg){: class="hight"} ![Strip board]({{ site.url }}/assets/200217_stripboard.png){: class="hight"}
{: class="centr"}
...
![Diagram of a c-shaped gripper]({{ site.url }}/assets/200217_gripper.png){: class="hight"} 
{: class="centr"}
...
![Forwards facing camera mockup]({{ site.url }}/assets/200217_forwards_camera.jpg){: class="hight"}
{: class="centr"}
...
![A test photo]({{ site.url }}/assets/200217_line.jpg){: class="hight"} ![MATLAB output]({{ site.url }}/assets/200217_line_analysis.png){: class="hight"}
{: class="centr"}
...
![Hubcap render]({{ site.url }}/assets/200217_hubcap.png){: class="hight"} ![The hubcap unscrewed]({{ site.url }}/assets/200217_hubcap_unscrewed.jpg){: class="hight"}
{: class="centr"}

To wrap things off, check out the robot going in slow motion to see those sweet hubcaps spin!

![Going backwards in slow motion]({{ site.url }}/assets/200217_slowmo.gif){: class="hight"}
{: class="centr"}
